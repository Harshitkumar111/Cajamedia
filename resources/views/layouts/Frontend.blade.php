   ...
   <div class="container-fluid ">   {{--mb-5 --}}
        <div class="row border-top px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0 {{(request()->segment(1) == 'home') ? 'show' : '' }} " id="navbar-vertical">
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="/shop" class="nav-item nav-link {{(request()->segment(1) == 'shop') ? 'active' : '' }}">Shop</a>
                            <a href="/shopdetail" class="nav-item nav-link {{(request()->segment(1) == 'shopdetail') ? 'active' : '' }}">Shop Detail</a>
                            <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-profile">
                           <span>  {{ Auth::user()->first_name }}  {{ Auth::user()->last_name }} <i class="fa fa-angle-down text-dark"></i></span>
                        ...
                        {{-- <div class="navbar-nav ml-auto py-0">
                            <div class="col-lg-3 d-none d-lg-block">
                                ...
                                <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                                    <div class="navbar-nav w-100 overflow-hidden" style="height: 41px">
